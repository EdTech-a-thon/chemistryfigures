...
<Seo
  description="Free generators for clean, printable chemistry figures. Make one to fit your lesson, then copy it straight into a test, worksheet or slide."
  path="/"
/>

<div class="page">
  <header class="hero">
    <h1>Chemistry figures for your tests and worksheets</h1>
