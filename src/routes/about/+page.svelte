...
<Seo title="About" description="Chemistry Figures is a free set of generators for printable chemistry figures, from teacher.dev." path="/about" />

<div class="page">
  <a class="back" href="/">← All figures</a>
  <h1>About</h1>
  <p class="sub">Clean chemistry figures, made to fit your lesson.</p>
  ...
  <section class="card">
    ...
    <p>
      Chemistry Figures is a set of generators for the figures teachers put in tests and worksheets.
      It's a project from
  ...
  <section class="card">
    ...
    <a class="btn-dark" href="mailto:directors@teacher.dev?subject=Chemistry%20Figures%20feedback">Email directors@teacher.dev</a>
  </section>
</div>
