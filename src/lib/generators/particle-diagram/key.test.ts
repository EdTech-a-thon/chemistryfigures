...
import { RADIUS, particleDiscs, type ParticleKind } from './particles'
import { BOX_SIDE } from './settings'

const anion: ParticleKind = { count: 4, look: { size: 'l', shade: 'light', charge: '-' }, name: 'Any negative ion' }
const cation: ParticleKind = { count: 0, look: { size: 's', shade: 'white', charge: '+' }, name: 'Na⁺' }
const big: ParticleKind = { count: 2, look: { size: 'xl', shade: 'black', charge: '' }, name: 'Ar' }
